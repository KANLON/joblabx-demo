...
public class JExcelOption {
	 ...
	 * @return 返回嵌套list集合
	 */
	public static List<ArrayList<String>> readExcel(String path) throws BiffException, IOException {
	 ...
	 */
	public static List<HashMap<String, String>> readExcel2(String path) throws BiffException, IOException {
		File f = new File(path);
		Workbook book = Workbook.getWorkbook(f);//
		Sheet sheet = book.getSheet(0); // 获得第一个工作表对象
		// 存放所有excel表信息
	 ...
	 * @throws IOException
	 */
	public static boolean writeExcel(List<ArrayList<String>> outList, String targetExcelPath)
	 ...
	 * @throws RowsExceededException
	 */
	public static Boolean compareTwoTable(String excelPath1, String excelPath2, String compareResultPath)
		...
		list1 = readExcel(excelPath1);
		list2 = readExcel(excelPath2);
		...
		writeExcel(list1, compareResultPath);
		return flag;
	}
	 ...
	 * @throws RowsExceededException
	 */
	public static Boolean compareAwardTable(String paperPath, String elecPath)
			throws BiffException, IOException, RowsExceededException, WriteException {
		List<ArrayList<String>> list1 = new ArrayList<>();
		List<ArrayList<String>> list2 = new ArrayList<>();
		Boolean flag = true;
		list1 = readExcel(paperPath);
		list2 = readExcel(elecPath);
		// 获取电子版的标题
		List<String> tableTitleList2 = new ArrayList<>();
		for (int i = 0; i < list2.get(0).size(); i++) {
			tableTitleList2.add(list2.get(0).get(i));
